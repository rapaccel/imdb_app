...
$SearchTvEventCopyWith<SearchTvEvent> get copyWith => _$SearchTvEventCopyWithImpl<SearchTvEvent>(this as SearchTvEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchTvEvent&&(identical(other.query, query) || other.query == query));
}
...
/// @nodoc
abstract mixin class $SearchTvEventCopyWith<$Res>  {
  factory $SearchTvEventCopyWith(SearchTvEvent value, $Res Function(SearchTvEvent) _then) = _$SearchTvEventCopyWithImpl;
@useResult
$Res call({
 String query
});
...
class _$SearchTvEventCopyWithImpl<$Res>
  ...
  _$SearchTvEventCopyWithImpl(this._self, this._then);

  final SearchTvEvent _self;
...
/// Adds pattern-matching-related methods to [SearchTvEvent].
extension SearchTvEventPatterns on SearchTvEvent {
...
class _Search implements SearchTvEvent {
...
@override
String toString() {
  return 'SearchTvEvent.search(query: $query)';
}
...
/// @nodoc
abstract mixin class _$SearchCopyWith<$Res> implements $SearchTvEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchTvState);
}
...
/// @nodoc
class $SearchTvStateCopyWith<$Res>  {
$SearchTvStateCopyWith(SearchTvState _, $Res Function(SearchTvState) __);
}


/// Adds pattern-matching-related methods to [SearchTvState].
extension SearchTvStatePatterns on SearchTvState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements SearchTvState {
  const _Initial();
...
class _Loading implements SearchTvState {
  const _Loading();
...
class _Loaded implements SearchTvState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $SearchTvStateCopyWith<$Res> {
...
class _Error implements SearchTvState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $SearchTvStateCopyWith<$Res> {
...
class _Empty implements SearchTvState {
  const _Empty();
