...
class _Fetch implements PopularTvEvent {
  const _Fetch();
...
class _Initial implements PopularTvState {
  const _Initial();
...
class _Loading implements PopularTvState {
  const _Loading();
...
class _Loaded implements PopularTvState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PopularTvStateCopyWith<$Res> {
...
class _Error implements PopularTvState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PopularTvStateCopyWith<$Res> {
...
class _Empty implements PopularTvState {
  const _Empty();
