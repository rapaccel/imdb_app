...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NowPlayingMoviesEvent);
}
...
/// @nodoc
class $NowPlayingMoviesEventCopyWith<$Res>  {
$NowPlayingMoviesEventCopyWith(NowPlayingMoviesEvent _, $Res Function(NowPlayingMoviesEvent) __);
}


/// Adds pattern-matching-related methods to [NowPlayingMoviesEvent].
extension NowPlayingMoviesEventPatterns on NowPlayingMoviesEvent {
...
class _Fetch implements NowPlayingMoviesEvent {
  const _Fetch();
...
class _Loaded implements NowPlayingMoviesState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $NowPlayingMoviesStateCopyWith<$Res> {
