...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TopRatedMoviesEvent);
}
...
$TopRatedMoviesEventCopyWith(TopRatedMoviesEvent _, $Res Function(TopRatedMoviesEvent) __);
}
...
class _Fetch implements TopRatedMoviesEvent {
  const _Fetch();
...
@override
String toString() {
  return 'TopRatedMoviesEvent.fetch()';
}
...
class _Loading implements TopRatedMoviesState {
  const _Loading();
...
class _Loaded implements TopRatedMoviesState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $TopRatedMoviesStateCopyWith<$Res> {
...
class _Error implements TopRatedMoviesState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TopRatedMoviesStateCopyWith<$Res> {
...
class _Empty implements TopRatedMoviesState {
  const _Empty();
...
@override
String toString() {
  return 'TopRatedMoviesState.empty()';
}
