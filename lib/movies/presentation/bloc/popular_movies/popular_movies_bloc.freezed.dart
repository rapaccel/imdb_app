...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PopularMoviesEvent);
}
...
$PopularMoviesEventCopyWith(PopularMoviesEvent _, $Res Function(PopularMoviesEvent) __);
}


/// Adds pattern-matching-related methods to [PopularMoviesEvent].
extension PopularMoviesEventPatterns on PopularMoviesEvent {
...
class _Fetch implements PopularMoviesEvent {
  const _Fetch();
...
class _Loaded implements PopularMoviesState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PopularMoviesStateCopyWith<$Res> {
...
class _Empty implements PopularMoviesState {
  const _Empty();
